 ...
 *
 */
package net.mcreator.stationbuildingmod;
...
@Mod("station_building_mod")
public class StationBuildingModMod {
	public static final Logger LOGGER = LogManager.getLogger(StationBuildingModMod.class);
	public static final String MODID = "station_building_mod";
